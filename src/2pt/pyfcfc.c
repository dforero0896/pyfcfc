...
#define __PYX_HAVE__pyfcfc
#define __PYX_HAVE_API__pyfcfc
/* Early includes */
#include <omp.h>
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'pyfcfc' */
...
static CF *__pyx_f_6pyfcfc_cf_init_noconf(int, int, int, int, __Pyx_memviewslice, __Pyx_memviewslice, int, int const *, int, int *, int); /*proto*/
static KDT *__pyx_f_6pyfcfc_kdtree_init_(DATA *, size_t const ); /*proto*/
static KDT *__pyx_f_6pyfcfc_kdtree_build_(DATA *, size_t const , DATA *, int *); /*proto*/
static DATA *__pyx_f_6pyfcfc_npy_to_data(__Pyx_memviewslice, __Pyx_memviewslice, int, int); /*proto*/
...
#define __Pyx_MODULE_NAME "pyfcfc"
extern int __pyx_module_is_main_pyfcfc;
int __pyx_module_is_main_pyfcfc = 0;

/* Implementation of 'pyfcfc' */
...
static const char __pyx_k_pyfcfc[] = "pyfcfc";
...
static const char __pyx_k_c_poles[] = "c_poles";
...
static const char __pyx_k_compute_wp[] = "compute_wp";
...
static const char __pyx_k_poles_should_be_an_empty_list_w[] = "'poles' should be an empty list with 'bin_scheme=2'";
...
static PyObject *__pyx_kp_u_poles_should_be_an_empty_list_w;
static PyObject *__pyx_n_s_pyfcfc;
...
static PyObject *__pyx_pf_6pyfcfc_count_pairs_npy(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_is_auto, __Pyx_memviewslice __pyx_v_data_1, __Pyx_memviewslice __pyx_v_weights_1, __Pyx_memviewslice __pyx_v_sbin_arr, int __pyx_v_n_mu_bin, __Pyx_memviewslice __pyx_v_pibin_arr, int __pyx_v_bin_scheme, PyObject *__pyx_v_poles, CYTHON_UNUSED int __pyx_v_compute_wp, PyObject *__pyx_v_use_wt, __Pyx_memviewslice __pyx_v_data_2, __Pyx_memviewslice __pyx_v_weights_2, int __pyx_v_nthreads); /* proto */
...
static CF *__pyx_f_6pyfcfc_cf_init_noconf(int __pyx_v_verbose, int __pyx_v_nthread, int __pyx_v_bin_scheme, int __pyx_v_nmu, __Pyx_memviewslice __pyx_v_sbin_arr, __Pyx_memviewslice __pyx_v_pibin_arr, int __pyx_v_dprec, int const *__pyx_v_use_wt, int __pyx_v_compute_wp, int *__pyx_v_poles, int __pyx_v_npole) {
  CF *__pyx_v_cf;
  int __pyx_v_prec;
  size_t __pyx_v_i;
  real __pyx_v_min;
 ...
 *     #cf.coord = cnvt_init()
 */
  __pyx_v_cf->poles = __pyx_v_poles;
 ...
 *     #if fcnvt != NULL:
 */
  __pyx_v_cf->comp_wp = __pyx_v_compute_wp;
 ...
 */
    __pyx_v_cf->mp = ((double **)malloc(((sizeof(double *)) * __pyx_v_cf->ncf)));
 ...
 *             return NULL
 */
      (void)(fprintf(stderr, ((char const *)"ERROR: failed to allocate memory for correlation function multipoles.\n")));
 ...
 *         if not cf.mp[0]:
 */
    __pyx_v_ntot = (((size_t)__pyx_v_cf->nl) * __pyx_v_cf->ns);
 ...
 *             fprintf(stderr, "ERROR: failed to allocate memory for correlation function multipoles.\n")
 */
    (__pyx_v_cf->mp[0]) = ((double *)calloc((__pyx_v_ntot * __pyx_v_cf->ncf), (sizeof(double))));
 ...
 */
      (__pyx_v_cf->mp[__pyx_v_i]) = ((__pyx_v_cf->mp[0]) + (__pyx_v_ntot * __pyx_v_i));
    }
 ...
 *         if not cf.wp:
 */
  __pyx_t_1 = (__pyx_v_cf->comp_wp != 0);
  if (__pyx_t_1) {
 ...
 */
    __pyx_v_cf->wp = ((double **)malloc(((sizeof(double *)) * __pyx_v_cf->ncf)));
 ...
 *             return NULL
 */
      (void)(fprintf(stderr, ((char const *)"ERROR: failed to allocate memory for projected correlation function.\n")));
 ...
 *             fprintf(stderr, "ERROR: failed to allocate memory for projected correlation function.\n")
 */
    (__pyx_v_cf->wp[0]) = ((double *)calloc((__pyx_v_cf->ns * __pyx_v_cf->ncf), (sizeof(double))));
 ...
 *     if verbose:
 */
      (__pyx_v_cf->wp[__pyx_v_i]) = ((__pyx_v_cf->wp[0]) + (((size_t)__pyx_v_cf->ns) * __pyx_v_i));
    }
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("pyfcfc.cf_init_noconf", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
static KDT *__pyx_f_6pyfcfc_kdtree_init_(DATA *__pyx_v_data, size_t const __pyx_v_ndata) {
  KDT *__pyx_v_node;
  KDT *__pyx_r;
...
static KDT *__pyx_f_6pyfcfc_kdtree_build_(DATA *__pyx_v_data, size_t const __pyx_v_ndata, DATA *__pyx_v_buf, int *__pyx_v_err) {
  KDT *__pyx_v_node;
  int __pyx_v_k;
 ...
 */
  __pyx_v_node = __pyx_f_6pyfcfc_kdtree_init_(__pyx_v_data, __pyx_v_ndata);
 ...
 *     return node
 */
  __pyx_v_node->left = __pyx_f_6pyfcfc_kdtree_build_(__pyx_v_data, __pyx_v_n, __pyx_v_buf, __pyx_v_err);
 ...
 * 
 */
  __pyx_v_node->right = __pyx_f_6pyfcfc_kdtree_build_((__pyx_v_data + __pyx_v_n), (__pyx_v_ndata - __pyx_v_n), __pyx_v_buf, __pyx_v_err);
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("pyfcfc.kdtree_build_", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
static DATA *__pyx_f_6pyfcfc_npy_to_data(__Pyx_memviewslice __pyx_v_positions, __Pyx_memviewslice __pyx_v_weights, int __pyx_v_nobj, CYTHON_UNUSED int __pyx_v_nthread) {
  Py_ssize_t __pyx_v_i;
  DATA *__pyx_v_data;
  DATA *__pyx_r;
  int __pyx_t_1;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("pyfcfc.npy_to_data", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6pyfcfc_1count_pairs_npy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6pyfcfc_1count_pairs_npy = {"count_pairs_npy", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6pyfcfc_1count_pairs_npy, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6pyfcfc_1count_pairs_npy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_is_auto;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_is_auto,&__pyx_n_s_data_1,&__pyx_n_s_weights_1,&__pyx_n_s_sbin_arr,&__pyx_n_s_n_mu_bin,&__pyx_n_s_pibin_arr,&__pyx_n_s_bin_scheme,&__pyx_n_s_poles,&__pyx_n_s_compute_wp,&__pyx_n_s_use_wt,&__pyx_n_s_data_2,&__pyx_n_s_weights_2,&__pyx_n_s_nthreads,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_data_1)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 1); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_weights_1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 2); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sbin_arr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 3); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_mu_bin)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 4); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pibin_arr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 5); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_bin_scheme)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 6); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_poles)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 7); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_compute_wp)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 8); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_use_wt)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 9); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_data_2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 10); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_weights_2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 11); __PYX_ERR(0, 695, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 12:
        if (likely((values[12] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nthreads)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, 12); __PYX_ERR(0, 695, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "count_pairs_npy") < 0)) __PYX_ERR(0, 695, __pyx_L3_error)
      }
    ...
    __pyx_v_is_auto = __Pyx_PyObject_IsTrue(values[0]); if (unlikely((__pyx_v_is_auto == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 695, __pyx_L3_error)
    __pyx_v_data_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_real(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_data_1.memview)) __PYX_ERR(0, 696, __pyx_L3_error)
    __pyx_v_weights_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn_real(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_weights_1.memview)) __PYX_ERR(0, 697, __pyx_L3_error)
    __pyx_v_sbin_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sbin_arr.memview)) __PYX_ERR(0, 698, __pyx_L3_error)
    __pyx_v_n_mu_bin = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_n_mu_bin == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 699, __pyx_L3_error)
    __pyx_v_pibin_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_pibin_arr.memview)) __PYX_ERR(0, 700, __pyx_L3_error)
    __pyx_v_bin_scheme = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_bin_scheme == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 701, __pyx_L3_error)
    __pyx_v_poles = ((PyObject*)values[7]);
    __pyx_v_compute_wp = __Pyx_PyObject_IsTrue(values[8]); if (unlikely((__pyx_v_compute_wp == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 703, __pyx_L3_error)
    __pyx_v_use_wt = ((PyObject*)values[9]);
    __pyx_v_data_2 = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn_real(values[10], PyBUF_WRITABLE); if (unlikely(!__pyx_v_data_2.memview)) __PYX_ERR(0, 705, __pyx_L3_error)
    __pyx_v_weights_2 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn_real(values[11], PyBUF_WRITABLE); if (unlikely(!__pyx_v_weights_2.memview)) __PYX_ERR(0, 706, __pyx_L3_error)
    __pyx_v_nthreads = __Pyx_PyInt_As_int(values[12]); if (unlikely((__pyx_v_nthreads == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 707, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("count_pairs_npy", 1, 13, 13, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 695, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyfcfc.count_pairs_npy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_poles), (&PyList_Type), 1, "poles", 1))) __PYX_ERR(0, 702, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_use_wt), (&PyList_Type), 1, "use_wt", 1))) __PYX_ERR(0, 704, __pyx_L1_error)
  __pyx_r = __pyx_pf_6pyfcfc_count_pairs_npy(__pyx_self, __pyx_v_is_auto, __pyx_v_data_1, __pyx_v_weights_1, __pyx_v_sbin_arr, __pyx_v_n_mu_bin, __pyx_v_pibin_arr, __pyx_v_bin_scheme, __pyx_v_poles, __pyx_v_compute_wp, __pyx_v_use_wt, __pyx_v_data_2, __pyx_v_weights_2, __pyx_v_nthreads);
...
static PyObject *__pyx_pf_6pyfcfc_count_pairs_npy(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_is_auto, __Pyx_memviewslice __pyx_v_data_1, __Pyx_memviewslice __pyx_v_weights_1, __Pyx_memviewslice __pyx_v_sbin_arr, int __pyx_v_n_mu_bin, __Pyx_memviewslice __pyx_v_pibin_arr, int __pyx_v_bin_scheme, PyObject *__pyx_v_poles, CYTHON_UNUSED int __pyx_v_compute_wp, PyObject *__pyx_v_use_wt, __Pyx_memviewslice __pyx_v_data_2, __Pyx_memviewslice __pyx_v_weights_2, int __pyx_v_nthreads) {
  int __pyx_v_n_s_bin;
 ...
 */
  ...
  __pyx_t_3 = PyList_GET_SIZE(__pyx_v_use_wt); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 709, __pyx_L1_error)
 ...
 */
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 710, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_3 = PyList_GET_SIZE(__pyx_v_use_wt); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 711, __pyx_L1_error)
 ...
 */
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 712, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_Raise(__pyx_t_4, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  __pyx_t_3 = PyList_GET_SIZE(__pyx_v_poles); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 716, __pyx_L1_error)
  __pyx_v_n_mp = __pyx_t_3;
 ...
 *         n_tot_bin = n_s_bin
 */
    __pyx_v_n_tot_bin = (__pyx_v_n_s_bin * __pyx_v_n_mp);
 ...
 */
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 731, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_Raise(__pyx_t_4, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 * 
 */
    __pyx_t_4 = __Pyx_PyUnicode_From_int(__pyx_v_bin_scheme, 0, ' ', 'd'); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 733, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyUnicode_Concat(__pyx_kp_u_bin_scheme_must_be_0_1_or_2_not, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 733, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_builtin_ValueError, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 733, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
 ...
 *     fflush(stdout)
 */
  __pyx_v_dat_1 = __pyx_f_6pyfcfc_npy_to_data(__pyx_v_data_1, __pyx_v_weights_1, (__pyx_v_data_1.shape[0]), __pyx_v_nthreads);
 ...
 *         fflush(stdout)
 */
    __pyx_v_dat_2 = __pyx_f_6pyfcfc_npy_to_data(__pyx_v_data_2, __pyx_v_weights_2, (__pyx_v_data_2.shape[0]), __pyx_v_nthreads);
 ...
 */
  ...
  __pyx_t_3 = PyList_GET_SIZE(__pyx_v_poles); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 766, __pyx_L1_error)
  __pyx_v_c_poles = ((int *)malloc((__pyx_t_3 * (sizeof(int)))));
 ...
 */
  ...
  __pyx_t_3 = PyList_GET_SIZE(__pyx_v_poles); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 767, __pyx_L1_error)
  __pyx_t_6 = __pyx_t_3;
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
 ...
 */
    ...
    __pyx_t_4 = __Pyx_GetItemInt_List(__pyx_v_poles, __pyx_v_err, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 768, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_8 = __Pyx_PyInt_As_int(__pyx_t_4); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 768, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    (__pyx_v_c_poles[__pyx_v_err]) = __pyx_t_8;
  }
 ...
 */
  ...
  __pyx_t_3 = PyList_GET_SIZE(__pyx_v_use_wt); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 771, __pyx_L1_error)
  __pyx_t_6 = __pyx_t_3;
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    __pyx_v_err = __pyx_t_7;
 ...
 */
    ...
    __pyx_t_4 = __Pyx_GetItemInt_List(__pyx_v_use_wt, __pyx_v_err, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 772, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 772, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_v_weights_1.shape[0];
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_v_weights_1.shape[0])) __pyx_t_7 = 0;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 780, __pyx_L1_error)
    }
    (__pyx_v_c_wdata[__pyx_t_10]) = ((__pyx_v_c_wdata[__pyx_t_10]) + (*((real *) ( /* dim=0 */ (__pyx_v_weights_1.data + __pyx_t_11 * __pyx_v_weights_1.strides[0]) ))));
  }
 ...
 */
      ...
      __pyx_t_7 = -1;
      if (__pyx_t_11 < 0) {
        __pyx_t_11 += __pyx_v_weights_2.shape[0];
        if (unlikely(__pyx_t_11 < 0)) __pyx_t_7 = 0;
      } else if (unlikely(__pyx_t_11 >= __pyx_v_weights_2.shape[0])) __pyx_t_7 = 0;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 783, __pyx_L1_error)
      }
      (__pyx_v_c_wdata[__pyx_t_10]) = ((__pyx_v_c_wdata[__pyx_t_10]) + (*((real *) ( /* dim=0 */ (__pyx_v_weights_2.data + __pyx_t_11 * __pyx_v_weights_2.strides[0]) ))));
    }
 ...
 */
  ...
  __pyx_t_3 = PyList_GET_SIZE(__pyx_v_poles); if (unlikely(__pyx_t_3 == ((Py_ssize_t)-1))) __PYX_ERR(0, 796, __pyx_L1_error)
 ...
 */
  __pyx_v_cf = __pyx_f_6pyfcfc_cf_init_noconf(1, __pyx_v_nthreads, __pyx_v_bin_scheme, __pyx_v_n_mu_bin, __pyx_v_sbin_arr, __pyx_v_pibin_arr, __pyx_v_dprec, __pyx_v_c_use_wt, 0, __pyx_v_c_poles, __pyx_t_3);
 ...
 */
  ...
  __pyx_t_4 = __Pyx_GetItemInt_List(__pyx_v_use_wt, 0, long, 1, __Pyx_PyInt_From_long, 1, 0, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 802, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely(__pyx_t_2 < 0)) __PYX_ERR(0, 802, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (!__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
  ...
  __pyx_t_4 = __Pyx_GetItemInt_List(__pyx_v_use_wt, 1, long, 1, __Pyx_PyInt_From_long, 1, 0, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 802, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely(__pyx_t_2 < 0)) __PYX_ERR(0, 802, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_1 = __pyx_t_2;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_empty); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 803, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyInt_FromSize_t(__pyx_v_cf->ntot); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 803, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_12 = PyTuple_New(1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 803, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_GIVEREF(__pyx_t_4);
    PyTuple_SET_ITEM(__pyx_t_12, 0, __pyx_t_4);
    __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 803, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_GetModuleGlobalName(__pyx_t_13, __pyx_n_s_np); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 803, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_t_13, __pyx_n_s_double); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 803, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_14) < 0) __PYX_ERR(0, 803, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    __pyx_t_14 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_12, __pyx_t_4); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 803, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_v_out_pair_counts = __pyx_t_14;
    __pyx_t_14 = 0;
 ...
 */
  /*else*/ {
    __Pyx_GetModuleGlobalName(__pyx_t_14, __pyx_n_s_np); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 806, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_14, __pyx_n_s_empty); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 806, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    __pyx_t_14 = __Pyx_PyInt_FromSize_t(__pyx_v_cf->ntot); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 806, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __pyx_t_12 = PyTuple_New(1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 806, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_GIVEREF(__pyx_t_14);
    PyTuple_SET_ITEM(__pyx_t_12, 0, __pyx_t_14);
    __pyx_t_14 = 0;
    __pyx_t_14 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 806, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_np); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 806, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_13 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_int64); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 806, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    if (PyDict_SetItem(__pyx_t_14, __pyx_n_s_dtype, __pyx_t_13) < 0) __PYX_ERR(0, 806, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __pyx_t_13 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_12, __pyx_t_14); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 806, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_13, __pyx_n_s_np); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 808, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_13);
  __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_t_13, __pyx_n_s_empty); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 808, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
  __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
  __pyx_t_13 = __Pyx_PyInt_FromSize_t(__pyx_v_cf->ntot); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 808, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_13);
  __pyx_t_12 = PyTuple_New(1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 808, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_GIVEREF(__pyx_t_13);
  PyTuple_SET_ITEM(__pyx_t_12, 0, __pyx_t_13);
  __pyx_t_13 = 0;
  __pyx_t_13 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 808, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_13);
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 808, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_double); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 808, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_13, __pyx_n_s_dtype, __pyx_t_5) < 0) __PYX_ERR(0, 808, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_14, __pyx_t_12, __pyx_t_13); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 808, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
 ...
 */
    ...
    __pyx_t_5 = __Pyx_GetItemInt_List(__pyx_v_use_wt, 0, long, 1, __Pyx_PyInt_From_long, 1, 0, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 815, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 815, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
      ...
      __pyx_t_5 = __Pyx_GetItemInt_List(__pyx_v_use_wt, 0, long, 1, __Pyx_PyInt_From_long, 1, 0, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 818, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_1 < 0)) __PYX_ERR(0, 818, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      if (__pyx_t_1) {
 ...
 */
        __pyx_t_10 = 0;
        __pyx_t_6 = __pyx_v_i;
        ((__pyx_v_cf->cnt[__pyx_t_10])[__pyx_t_6]).d = (((__pyx_v_cf->cnt[__pyx_t_10])[__pyx_t_6]).d * 2.0);
 ...
 */
      /*else*/ {
        __pyx_t_10 = 0;
        __pyx_t_6 = __pyx_v_i;
        ((__pyx_v_cf->cnt[__pyx_t_10])[__pyx_t_6]).i = (((__pyx_v_cf->cnt[__pyx_t_10])[__pyx_t_6]).i * 2);
      }
      __pyx_L26:;
    }
 ...
 */
    ...
    __pyx_t_5 = __Pyx_GetItemInt_List(__pyx_v_use_wt, 0, long, 1, __Pyx_PyInt_From_long, 1, 0, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 825, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_2 < 0)) __PYX_ERR(0, 825, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    if (!__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
    ...
    __pyx_t_5 = __Pyx_GetItemInt_List(__pyx_v_use_wt, 1, long, 1, __Pyx_PyInt_From_long, 1, 0, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 825, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_2 < 0)) __PYX_ERR(0, 825, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_1 = __pyx_t_2;
 ...
 */
      __pyx_t_5 = PyFloat_FromDouble(((__pyx_v_cf->cnt[0])[__pyx_v_i]).d); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 835, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      if (unlikely(__Pyx_SetItemInt(__pyx_v_out_pair_counts, __pyx_v_i, __pyx_t_5, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 835, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
    /*else*/ {
      __pyx_t_5 = __Pyx_PyInt_FromSize_t(((__pyx_v_cf->cnt[0])[__pyx_v_i]).i); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 842, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      if (unlikely(__Pyx_SetItemInt(__pyx_v_out_pair_counts, __pyx_v_i, __pyx_t_5, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 842, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 * 
 */
    __pyx_t_5 = __Pyx_GetItemInt(__pyx_v_out_pair_counts, __pyx_v_i, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 847, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_13 = PyFloat_FromDouble((__pyx_v_cf->norm[0])); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 847, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_12 = __Pyx_PyNumber_Divide(__pyx_t_5, __pyx_t_13); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 847, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    if (unlikely(__Pyx_SetItemInt(__pyx_v_out_norm_pair_counts, __pyx_v_i, __pyx_t_12, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 1) < 0)) __PYX_ERR(0, 847, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  }
 ...
 */
  ...
  __pyx_t_12 = PyTuple_New(2); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 851, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_INCREF(__pyx_v_out_pair_counts);
  __Pyx_GIVEREF(__pyx_v_out_pair_counts);
  PyTuple_SET_ITEM(__pyx_t_12, 0, __pyx_v_out_pair_counts);
  __Pyx_INCREF(__pyx_v_out_norm_pair_counts);
  __Pyx_GIVEREF(__pyx_v_out_norm_pair_counts);
  PyTuple_SET_ITEM(__pyx_t_12, 1, __pyx_v_out_norm_pair_counts);
  __pyx_r = __pyx_t_12;
  __pyx_t_12 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyfcfc._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_pyfcfc(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_pyfcfc},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_c_poles, __pyx_k_c_poles, sizeof(__pyx_k_c_poles), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_compute_wp, __pyx_k_compute_wp, sizeof(__pyx_k_compute_wp), 0, 0, 1, 1},
  ...
  {&__pyx_kp_u_poles_should_be_an_empty_list_w, __pyx_k_poles_should_be_an_empty_list_w, sizeof(__pyx_k_poles_should_be_an_empty_list_w), 0, 1, 0, 0},
  {&__pyx_n_s_pyfcfc, __pyx_k_pyfcfc, sizeof(__pyx_k_pyfcfc), 0, 0, 1, 1},
...
static CYTHON_SMALL_CODE int __Pyx_InitCachedBuiltins(void) {
  ...
  __pyx_builtin_ValueError = __Pyx_GetBuiltinName(__pyx_n_s_ValueError); if (!__pyx_builtin_ValueError) __PYX_ERR(0, 710, __pyx_L1_error)
 ...
 *         raise ValueError("'use_wt' must be of length 2 for cross correlations.")
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_use_wt_must_be_one_element_long); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 710, __pyx_L1_error)
 ...
 *     n_s_bin = sbin_arr.shape[0] - 1
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_u_use_wt_must_be_of_length_2_for); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 712, __pyx_L1_error)
 ...
 *         raise ValueError(f"'bin_scheme' must be 0, 1 or 2, not {bin_scheme}")
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_u_poles_should_be_an_empty_list_w); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 731, __pyx_L1_error)
 ...
 *                     real[:] weights_1,
 */
  __pyx_tuple__22 = PyTuple_Pack(33, __pyx_n_s_is_auto, __pyx_n_s_data_1, __pyx_n_s_weights_1, __pyx_n_s_sbin_arr, __pyx_n_s_n_mu_bin, __pyx_n_s_pibin_arr, __pyx_n_s_bin_scheme, __pyx_n_s_poles, __pyx_n_s_compute_wp, __pyx_n_s_use_wt, __pyx_n_s_data_2, __pyx_n_s_weights_2, __pyx_n_s_nthreads, __pyx_n_s_n_s_bin, __pyx_n_s_n_tot_bin, __pyx_n_s_n_mp, __pyx_n_s_n_p_bin, __pyx_n_s_buf, __pyx_n_s_err, __pyx_n_s_dat_1, __pyx_n_s_tree_1, __pyx_n_s_dat_2, __pyx_n_s_tree_2, __pyx_n_s_dprec, __pyx_n_s_c_poles, __pyx_n_s_c_use_wt, __pyx_n_s_c_ndata, __pyx_n_s_c_wdata, __pyx_n_s_j, __pyx_n_s_cf, __pyx_n_s_out_pair_counts, __pyx_n_s_out_norm_pair_counts, __pyx_n_s_i); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 695, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(13, 0, 33, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_2pt_pyfcfc_pyx, __pyx_n_s_count_pairs_npy, 695, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 695, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpyfcfc(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpyfcfc(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_pyfcfc(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_pyfcfc(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_pyfcfc(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'pyfcfc' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_pyfcfc(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("pyfcfc", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pyfcfc) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyfcfc")) {
      if (unlikely(PyDict_SetItemString(modules, "pyfcfc", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *                     real[:] weights_1,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6pyfcfc_1count_pairs_npy, NULL, __pyx_n_s_pyfcfc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 695, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_count_pairs_npy, __pyx_t_1) < 0) __PYX_ERR(0, 695, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyfcfc", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyfcfc");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
