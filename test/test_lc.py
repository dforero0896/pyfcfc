...
results = py_compute_cf([data, rand], [wdat, wran], np.arange(0, 200, 1, dtype=np.double), None, 100, "test/fcfc_lc_ell.conf")
...
results = py_compute_cf([data, rand], [wdat, wran], np.arange(0, 200, 1, dtype=np.double), None, 0, "test/fcfc_lc_iso.conf")  
